  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-neutral text-white shadow-lg z-50">
      <div className="navbar px-5 flex justify-between">
        <Link to="/feed" className="text-2xl font-bold text-green-400 hover:text-green-300 transition">
          DevTinder 🔥
        </Link>
        ...
        {user && (
          <div className="flex items-center gap-4">
            ...
            <div className="dropdown dropdown-end">
              <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar hover:bg-gray-700 transition">
                <div className="w-10 rounded-full border border-gray-500">
                  <img alt="User Photo" src={user.PhotoUrl || "/placeholder.svg"} />
                </div>
              </div>
              <ul
                tabIndex={0}
